...
# votes snapshots
curl https://bcapi.movapi.com/blockmeta/bytom2/v1/node/vote-transactions\?pub_key\=cc499725c708f272b3111c9e0694b66bba61f0321b14ee07b41cd677c9a633259bdbc96b9e67097d026dc9d4f859967194fd6e1770bf5cb6785c388d18486d80\&start\=0\&limit\=1000 | jq '.' > ${base_dir}/votes-`date '+%Y%m%d'`.log
